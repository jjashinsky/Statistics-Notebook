...
The $\chi^2$ test statistic can be assumed to follow a [chi-squared distribution](../ParametricDistributions.html#chisquared) with degrees of freedom $p = (r-1)\times(c-1)$ as long as the distribution of counts meets either of the following requirements.
